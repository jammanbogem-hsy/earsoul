...
} from '../../game/collectibleScale'
import { getSizeTier } from '../../game/mechanics'
import { getAssetBackedLevelUpModelId } from '../../game/levelUpAssets'
import { getStructuredCollectibleAsset } from '../../game/structuredCollectibleAssets'
import {
  getLevelOneAssetVariant,
  type LevelOneAssetVariant,
} from '../../game/levelOneAssets'
import {
  getTreeAssetVariation,
  type TreeAssetVariant,
} from '../../game/treeAssets'
import type {
  MudAssetVariant,
...
import candyLegoUrl from '../../assets/game/level1_candy_lego.glb?url'
import greenLegoUrl from '../../assets/game/level1_green_lego.glb?url'
import redLegoUrl from '../../assets/game/level1_red_lego.glb?url'
import yellowLegoUrl from '../../assets/game/level1_yellow_lego.glb?url'
import waterBottleUrl from '../../assets/game/water bottle 3d model.glb?url'
import orangeJuiceUrl from '../../assets/game/orange juice carton 3d model.glb?url'
import stopwatchModelUrl from '../../assets/game/stopwatch 3d model.glb?url'
import lowPolyTreeAUrl from '../../assets/game/low poly tree 3d model.glb?url'
import lowPolyTreeBUrl from '../../assets/game/low-poly tree 3d model.glb?url'
import lowPolyTreeCUrl from '../../assets/game/low-poly tree 3d model (1).glb?url'
import jumpingWaterBottleUrl from '../../assets/game/찰랑물병+점프.glb?url'
import runningSunglassesUrl from '../../assets/game/런닝용선글라스.glb?url'
import level2HeadsetUrl from '../../assets/game/헤드셋.glb?url'
import level2NoteUrl from '../../assets/game/노트.glb?url'
import level2RunningShoeUrl from '../../assets/game/러닝화.glb?url'
import level2DigitalWatchUrl from '../../assets/game/전자시계.glb?url'
import shimmeringRunningBagUrl from '../../assets/game/찰랑 러닝 가방.glb?url'
import catDollUrl from '../../assets/game/고양이 인형.glb?url'
import athleteRunningShoeUrl from '../../assets/game/선수 러닝화.glb?url'
import raccoonUrl from '../../assets/game/너구리.glb?url'
import inlineSkatesUrl from '../../assets/game/인라인스케이트.glb?url'
import runningVestUrl from '../../assets/game/러닝 조끼.glb?url'
import runningMedalUrl from '../../assets/game/함께 달린 메달.glb?url'
import sodaCoolerUrl from '../../assets/game/탄산음료 아이스박스.glb?url'
import catUrl from '../../assets/game/고양이.glb?url'
import carUrl from '../../assets/game/차1.glb?url'
import noiseCancelingHeadsetUrl from '../../assets/game/노이즈캔슬링 헤드셋.glb?url'
import luxuryCarUrl from '../../assets/game/대형 고급차.glb?url'
import luxuryCar2Url from '../../assets/game/대형 고급차2.glb?url'
import drinkVendingMachineUrl from '../../assets/game/음료 자판기.glb?url'
import benchChairUrl from '../../assets/game/벤치 의자.glb?url'
import phantomKeyringUrl from '../../assets/game/팬텀+키링.glb?url'
import beraIceCreamUrl from '../../assets/game/베라+아이스크림.glb?url'
import energyDrinkUrl from '../../assets/game/에너지드링크.glb?url'
import taekwondoUniformUrl from '../../assets/game/태권도복.glb?url'
import shibaInuUrl from '../../assets/game/시바견.glb?url'
import lotteTowerUrl from '../../assets/game/롯데타워.glb?url'
import treeRootObstacleUrl from '../../assets/game/장애물_나무 뿌리.glb?url'
import fallenLogAObstacleUrl from '../../assets/game/장애물_통나무.glb?url'
import fallenLogBObstacleUrl from '../../assets/game/장애물_통나무2.glb?url'
import mudAObstacleUrl from '../../assets/game/장애물_진흙밭.glb?url'
import mudBObstacleUrl from '../../assets/game/장애물_진흙밭2.glb?url'
