...
export const SIZE_TIERS = [
  { level: 1, label: '작은 조각', minSize: 0, maxSize: 0.45, color: '#2FA47C' },
  { level: 2, label: '보통 조각', minSize: 0.48, maxSize: 0.8, color: '#4169D8' },
  { level: 3, label: '큰 조각', minSize: 0.82, maxSize: 1.15, color: '#E6A800' },
  {
    level: 4,
    label: '아주 큰 조각',
    minSize: 1.18,
