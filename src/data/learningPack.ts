...
const stageBlueprints: StageBlueprint[] = [
  ...
  },
  {
    ...
    description: '어두운 숲에서 수집할수록 밝아지는 러닝볼과 함께 언덕, 물길, 진흙과 둔턱을 탐험해요.',
    theme: 'forest-trail',
    mapSize: 168,
    objectiveCount: 92,
